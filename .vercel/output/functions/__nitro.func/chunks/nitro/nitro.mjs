...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2025-08-15T00:24:14.518Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2025-08-15T00:24:14.518Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "ed508544-6154-421f-ae04-3f15f0f85b65",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/malware/Desktop/applicants.io/applicants-io-landing/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-scripts": {
  ...
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        ...
        "name": "Applicants.io",
        "description": "AI-Powered Recruiting. Fully Managed.",
        "defaultLocale": "en"
      }
    ],
    "version": "3.2.2",
...
const _UCyaCnqiCzswuUZl5KlACHmEgkj4X8MhPHjBOhk_Xk = defineNitroPlugin(async (nitroApp) => {
...
const _loHCLJruVwKy9UEoajZO5LzuIP11lXNi3EJNbsGxSw = defineNitroPlugin(async (nitroApp) => {
...
const componentNames = [{"hash":"SOHaoKfoo4fUkREsCFGw8ewxkl4-XkkHkug2VwYRtFM","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/Users/malware/Desktop/applicants.io/applicants-io-landing/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community"},{"hash":"tFoYPh0fXaZR3uXybAqFEOGnQuQsvz-E-Yq-CtrFlIY","pascalName":"Frame","kebabName":"frame","path":"/Users/malware/Desktop/applicants.io/applicants-io-landing/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community"},{"hash":"NPQTTXYQ8toXx5OaJ1VlRUUcxy1SNOxg-FoM7C08ZPM","pascalName":"Nuxt","kebabName":"nuxt","path":"/Users/malware/Desktop/applicants.io/applicants-io-landing/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community"},{"hash":"VAHSTZlVcPHzkozocV1iTnwc4-YttdoOkHsYfoSgDZ4","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/Users/malware/Desktop/applicants.io/applicants-io-landing/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community"},{"hash":"8CNn4yU043gQFqO-sZNDPz9GKED-h7ahXJ-61c9ThHM","pascalName":"Pergel","kebabName":"pergel","path":"/Users/malware/Desktop/applicants.io/applicants-io-landing/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community"},{"hash":"b-Juo-FXQepo6SOCnA478MTAqbXNZuve6-MzHgTKA7s","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/Users/malware/Desktop/applicants.io/applicants-io-landing/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community"},{"hash":"vRUm5ru-64PEHIGsBby6-vCgLBg7iUJfvFKL6VuCXtI","pascalName":"UnJs","kebabName":"un-js","path":"/Users/malware/Desktop/applicants.io/applicants-io-landing/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community"},{"hash":"hq07GBU-Yd16ICfETt8SfSxfaYj3qBmDAiQkTcv89nw","pascalName":"Wave","kebabName":"wave","path":"/Users/malware/Desktop/applicants.io/applicants-io-landing/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community"},{"hash":"zSwOodBXcjwS1qvFqGBJqitTEEnrvVfwQYkTeIxNpws","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/Users/malware/Desktop/applicants.io/applicants-io-landing/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community"}];
...
const _vX3HHxd8lSGK3KLF6dqfToCEnF2u0LMDCqfReKotN0 = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _2U0yYqYHMFijaiKu7XEFUyBNPee3iYOujjDCgqJ4yo = (function(nitro) {
...
const plugins = [
  _UCyaCnqiCzswuUZl5KlACHmEgkj4X8MhPHjBOhk_Xk,
_loHCLJruVwKy9UEoajZO5LzuIP11lXNi3EJNbsGxSw,
_vX3HHxd8lSGK3KLF6dqfToCEnF2u0LMDCqfReKotN0,
_2U0yYqYHMFijaiKu7XEFUyBNPee3iYOujjDCgqJ4yo
];

const _t7KcGs = eventHandler(async (e) => {
...
const _vWBMrk = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _cO60TK = defineEventHandler(async (e) => {
...
const _KLNSGj = defineEventHandler(async (e) => {
  const collections = [];
...
const _D9sndm = defineEventHandler(async (e) => {
...
const _ljyQMt = defineEventHandler(async (e) => {
...
const _t1SvXv = defineCachedEventHandler(async (event) => {
...
const appHead = {"link":[{"rel":"icon","href":"/favicon.ico"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Applicants.io runs your entire hiring engine — job boards, career site, CRM, automations, SEO, and employer branding."},{"name":"theme-color","content":"#0F172A"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"title":"Applicants.io – AI-Powered Recruiting. Fully Managed.","htmlAttrs":{}};
...
const _k8Ejsm = eventHandler(async (event) => {
...
const _wHZ2H7 = eventHandler(async (event) => {
...
const _23bqEx = lazyEventHandler(() => {
...
const _lazy_YTqfXw = () => import('../routes/renderer.mjs');
const _lazy_J2IkbL = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_G9pywu = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_YTqfXw, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _t7KcGs, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _vWBMrk, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _cO60TK, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _KLNSGj, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _D9sndm, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _ljyQMt, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_J2IkbL, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_G9pywu, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_G9pywu, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _t1SvXv, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _k8Ejsm, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _wHZ2H7, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _23bqEx, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_YTqfXw, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, fetchIsland as A, createHeadCore as B, normaliseFontInput as C, theme as D, withTrailingSlash as E, handleCacheHeaders as F, setHeaders as G, setHeader as H, hash$1 as I, parseURL as J, setResponseHeader as K, proxyRequest as L, sendRedirect as M, resolveContext as N, H3Error as O, klona as P, defuFn as Q, headSymbol as R, defu as S, hasProtocol as T, isScriptProtocol as U, joinURL as V, withQuery as W, useHead as X, sanitizeStatusCode as Y, getContext as Z, baseURL as _, getResponseStatus as a, createHooks as a0, isEqual as a1, withoutTrailingSlash as a2, titleCase as a3, executeAsync as a4, stringifyParsedURL as a5, stringifyQuery as a6, parseQuery as a7, toRouteMatcher as a8, createRouter$1 as a9, camelCase as aa, withoutBase as ab, useSeoMeta as ac, withLeadingSlash as ad, withBase as ae, resolveUnrefHeadInput as af, decodeHtml as ag, logger$1 as ah, toBase64Image as ai, htmlDecodeQuotes as aj, sendError as ak, fontCache as al, encodeParam as am, encodePath as an, listener as ao, appId as b, buildAssetsURL as c, defineRenderHandler as d, appTeleportTag as e, appTeleportAttrs as f, getResponseStatusText as g, getQuery as h, createError$1 as i, createSSRContext as j, appHead as k, destr as l, getRouteRules as m, getRenderer as n, getEntryIds as o, publicAssetsURL as p, replaceIslandTeleports as q, renderInlineStyles as r, setSSRError as s, defineEventHandler as t, useNitroApp as u, prefixStorage as v, useStorage as w, useNitroOrigin as x, emojiCache as y, useOgImageRuntimeConfig as z };
