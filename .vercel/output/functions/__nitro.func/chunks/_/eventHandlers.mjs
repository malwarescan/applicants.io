import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { v as prefixStorage, w as useStorage, x as useNitroOrigin, y as emojiCache, z as useOgImageRuntimeConfig, i as createError, A as fetchIsland, B as createHeadCore, C as normaliseFontInput, D as theme, E as withTrailingSlash, h as getQuery, F as handleCacheHeaders, G as setHeaders, H as setHeader, I as hash, J as parseURL, K as setResponseHeader, L as proxyRequest, M as sendRedirect, N as resolveContext, O as H3Error } from '../nitro/nitro.mjs';
