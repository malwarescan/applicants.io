import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, createApp, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, computed, isReadonly, isRef, isShallow, isReactive, toRaw, ref, toValue, mergeProps, getCurrentScope, watch, useSSRContext } from 'vue';
import { i as createError$1, P as klona, Q as defuFn, R as headSymbol, S as defu, T as hasProtocol, U as isScriptProtocol, V as joinURL, W as withQuery, X as useHead$1, Y as sanitizeStatusCode, Z as getContext, $ as $fetch$1, _ as baseURL, a0 as createHooks, a1 as isEqual, a2 as withoutTrailingSlash, a3 as titleCase, a4 as executeAsync, a5 as stringifyParsedURL, a6 as stringifyQuery, a7 as parseQuery, a8 as toRouteMatcher, a9 as createRouter, aa as camelCase, E as withTrailingSlash, J as parseURL, ab as withoutBase, ac as useSeoMeta$1, ad as withLeadingSlash, ae as withBase, af as resolveUnrefHeadInput } from '../nitro/nitro.mjs';
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-DkwwE0RF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-zUa0BVK5.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-DXw9nZ4b.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-ChtH5u0Z.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DX0msLd0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-BUEYKcuA.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-T_9a59-M.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-CuzYyTJP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-C1C1l3lD.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-DbgUa1do.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-DvVN_UbE.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-DMkJrQdi.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-eoE8umli.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-DK0U8dSH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-DX7Kc3jD.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-dNZddV6R.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-B5-BwaXy.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-BcvYbTJv.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-CRNTsQO-.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-BPdLIt9y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-ecj_wf-d.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-Dt2Liw9h.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-Zt1v1dPX.mjs').then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => import('./index-BwTdTtXW.mjs').then((r) => r["default"] || r.default || r));
...
function routeRuleOgImage(nuxtApp) {
  nuxtApp.hooks.hook("app:rendered", async (ctx) => {
    ...
    if (isInternalRoute(path))
      return;
    const _routeRulesMatcher = toRouteMatcher(
      createRouter({ routes: ssrContext?.runtimeConfig?.nitro?.routeRules })
    );
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-98a0f204"]]);
const _sfc_main$2 = {};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C44hC2yg.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DjY3UuSy.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-ElkBrpO5.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useRouter as a, useNuxtApp as b, createError as c, useRuntimeConfig as d, entry$1 as default, nuxtLinkDefaults as e, useRequestEvent as f, asyncDataDefaults as g, useAppConfig as h, injectHead as i, useOgImageRuntimeConfig as j, useSiteConfig as k, navigateTo as n, resolveRouteObject as r, useHead as u };
